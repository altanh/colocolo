#lang rosette
(require "../../ocelot.rkt" "../../lang/ast.rkt" "../../engine/interpretation.rkt" "../../lang/bounds.rkt" "../../lib/skolemize-solve.rkt")
;(define SS (make-SAT))
...
(println "skolemizing...")
(match-define (cons S-F S-bnds) (time (skolemize-merge bounds$60 b-f$392 4)))
(println "instantiating bounds...")
(define interp (time (instantiate-bounds S-bnds)))
(println "making boolean interpretation...")
(define F* (time (interpret* S-F interp)))
(println "making Rosette solver call...")
(define sol (time (solve (assert F*))))
;(println "making optimized SAT call...")
;(define sat-sol (time (SAT-solve SS (list F*))))